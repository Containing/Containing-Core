...
public class objPublisher {
    ...
    public void createVehicle(Vehicles.AGV vehicle){
        //42Byte total
        byte[] b = new byte[42];
        ...
        publisher.send(b, 0);
        System.out.println("Net: Creating AGV " + vehicleID);
    }
    ...
    public void syncVehicle(Vehicles.AGV vehicle){        
        //29Byte total
        byte[] b = new byte[29];
        ...
        publisher.send(b, 0);
        System.out.println("Net: Syncing AGV " + vehicleID);
    }
